const CACHE='concorso-quest-rt-v7';
const CORE=[
  ...
  './data/questions-orale-extra.js','./data/oral-bank-normalizer.js','./data/study-orale-extra.js','./data/oral-evaluator.js','./data/extra-loader.js'
];
